...
public abstract class Main extends Application {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("1) Аналіз тексту");
            System.out.println("2) Біграм");
            System.out.println("3) Двограм");
            System.out.println("4) Триграм");
            System.out.println("5) Шифр Цезаря");
            System.out.println("6) Шифр прямої підстановки");
            System.out.println("7) Шифр Вінженера");
            ...
            if (qwe == 1){
               ...
               Trigram.main(args);
                ...
                System.out.println("2) Розшифрувати");
                chz = scanner.nextInt();
                if (chz == 1) {
                    Chezar chezar = new Chezar();
                    chezar.zashifr();
                }else {
                    Chezar chezar = new Chezar();
                    chezar.rozshifr();
